...
class Position(BaseModel):
    ...
    closed_at: datetime | None = Field(None, description="Position close timestamp")
...
class PositionManager:
    ...
    def close_position(
        ...
        if self.closing_method == PositionClosingMethod.FIFO:
            return self._close_fifo(symbol, agent_id, quantity, exit_price)
        if self.closing_method == PositionClosingMethod.LIFO:
