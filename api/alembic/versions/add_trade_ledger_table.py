...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "agent_id", sa.String(), nullable=False, comment="Which agent generated this trade"
        ),
        sa.Column("strategy_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("symbol", sa.String(), nullable=False),
        sa.Column(
            "trade_type",
            sa.Enum("BUY", "SELL", name="trade_type"),
            nullable=False,
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Number of shares/contracts",
        ),
        sa.Column(
            "entry_price",
            sa.Numeric(precision=18, scale=8),
        ...
        sa.Column(
            "status",
            sa.Enum("OPEN", "CLOSED", "CANCELLED", name="trade_status"),
            nullable=False,
            default="OPEN",
        ...
        sa.Column(
            "execution_mode",
            sa.Enum("MOCK", "LIVE", name="execution_mode"),
            nullable=False,
            default="MOCK",
        ...
        sa.ForeignKeyConstraint(
            ["parent_trade_id"], ["trade_ledger.trade_id"], ondelete="SET NULL"
        ),
