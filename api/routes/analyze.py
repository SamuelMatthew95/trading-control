...
async def shadow_analyze(
    ...
    try:
        ...
        return StandardResponse(success=True, data={"mode": "shadow", "result": result}).model_dump()
    except HTTPException:
        raise
    except Exception as e:
...
async def analyze_options():
    return StandardResponse(success=True, data={"message": "Analyze endpoints support GET, POST, and OPTIONS"}).model_dump()
