...
const buttonVariants = cva(
  "inline-flex min-h-11 shrink-0 items-center justify-center rounded-lg border text-sm font-sans font-semibold whitespace-nowrap transition-colors outline-none select-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:size-4",
  {
    variants: {
      variant: {
        default:
          "border-indigo-600 bg-indigo-600 text-slate-100 hover:bg-indigo-700",
        outline:
          "border-slate-200 bg-transparent text-slate-600 hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800",
        secondary:
        ...
        destructive:
          "border-rose-600 bg-rose-600 text-slate-100 hover:bg-rose-700",
        success:
          "border-emerald-600 bg-emerald-600 text-slate-100 hover:bg-emerald-700",
