...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "px-2 py-2 text-left text-xs font-sans font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400",
        className,
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "px-2 py-2 text-sm font-sans text-slate-900 dark:text-slate-100",
        className,
      )}
      {...props}
    />
...
function TableCaption({
  ...
  return (
    <caption
      ...
      className={cn(
        "mt-4 text-xs font-sans text-slate-500 dark:text-slate-400",
        className,
      )}
      {...props}
    />
