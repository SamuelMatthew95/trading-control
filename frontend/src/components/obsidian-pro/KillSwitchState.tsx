    ...
    <>
      ...
      {isActive && (
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle at center, transparent 0%, rgba(239, 68, 68, 0.1) 50%, rgba(239, 68, 68, 0.2) 100%)",
      ...
      {isActive && (
        <motion.div
          ...
          style={{
            boxShadow:
              "inset 0 0 100px rgba(239, 68, 68, 0.3), 0 0 100px rgba(239, 68, 68, 0.2)",
      ...
      {isActive && (
        ...
        >
          <div className="flex items-center gap-2 px-3 py-2 bg-slate-900/90 border border-slate-700 rounded-lg backdrop-blur-sm">
      ...
      <div
        className={cn("transition-all duration-500", isActive && "opacity-90")}
      >
        {children}
      </div>
