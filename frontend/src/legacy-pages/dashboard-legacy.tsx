  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col">
        <Header
          title="Dashboard"
          subtitle="System vital signs and bot control"
        />
        <main className="flex-1 overflow-y-auto p-6">
          {/* System Vitals Grid */}
          <section className="mb-8">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-[0.7rem] uppercase tracking-widest text-slate-500">
                System Vital Signs
              </h2>
            </div>
            ...
            <SystemVitals
              health={displayData}
              isLoading={healthLoading && !prevDataRef.current}
            />
          </section>
