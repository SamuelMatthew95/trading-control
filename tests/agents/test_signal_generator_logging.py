...
from api.constants import MarketDirection, SignalType, SignalStrength, AGENT_SIGNAL
...
async def test_signal_generator_signal_strength_classification():
    ...
    test_cases = [
        {"pct": 0.5, "expected_type": SignalType.PRICE_UPDATE, "expected_strength": SignalStrength.LOW},
        {"pct": 2.0, "expected_type": SignalType.MOMENTUM, "expected_strength": SignalStrength.NORMAL},
        {"pct": 4.0, "expected_type": SignalType.STRONG_MOMENTUM, "expected_strength": SignalStrength.HIGH},
        {"pct": -1.0, "expected_type": SignalType.PRICE_UPDATE, "expected_strength": SignalStrength.LOW},
        {"pct": -2.5, "expected_type": SignalType.MOMENTUM, "expected_strength": SignalStrength.NORMAL},
        {"pct": -5.0, "expected_type": SignalType.STRONG_MOMENTUM, "expected_strength": SignalStrength.HIGH},
    ]
            ...
            with patch.object(signal_gen, '_begin_run', return_value=(True, 1)):
                with patch.object(signal_gen, '_persist_signal_complete'):
                    with patch('api.services.signal_generator.write_heartbeat'):
                        ...
                        publish_log_calls = [call for call in mock_log.call_args_list 
