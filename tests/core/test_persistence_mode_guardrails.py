...
def test_constants_has_proper_enums():
    ...
    from api.constants import StorageBackend, RuntimeMode, HealthStatus
...
def test_simplified_runtime_logic_works():
    ...
    from api.runtime_state import set_db_available, get_active_backend, get_runtime_mode
    from api.constants import StorageBackend, RuntimeMode
