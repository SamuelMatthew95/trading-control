...
CLEAN_FILES: frozenset[str] = frozenset(
    {
        ...
        "api/services/agents/challenger_agent.py",
        "api/services/agents/db_helpers.py",
        "api/services/agents/grade_agent.py",
        "api/services/agents/grade_analytics.py",
        "api/services/agents/ic_updater.py",
        "api/services/agents/notification_agent.py",
        ...
        "api/services/agents/reflection_agent.py",
        "api/services/agents/risk_guardian.py",
        "api/services/agents/scoring.py",
        "api/services/agents/strategy_proposer.py",
        "api/services/agents/system_architect.py",
        ...
        "api/services/metrics_calc.py",
        "api/services/multi_agent_memory.py",
        "api/services/multi_agent_models.py",
        "api/services/multi_agent_orchestrator.py",
        "api/services/multi_agent_pipeline.py",
        "api/services/multi_agent_reasoning.py",
        "api/services/multi_agent_tools.py",
        ...
        "api/services/proposal_brief.py",
        ...
        "api/services/tool_telemetry.py",
