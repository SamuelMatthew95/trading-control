...
# Files where SQL-bind-parameter dicts dominate. Dict-literal checks are
# relaxed (those keys must match :name placeholders in the SQL string), but
# the READ check (.get / subscript) is still fully enforced.
