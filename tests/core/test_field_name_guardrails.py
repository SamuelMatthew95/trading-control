...
CLEAN_FILES: frozenset[str] = frozenset(
    {
        ...
        "api/services/hybrid/candidate_gate.py",
        "api/services/hybrid/config.py",
        "api/services/hybrid/indicators.py",
        "api/services/hybrid/llm_decision.py",
        "api/services/hybrid/market_validator.py",
        "api/services/hybrid/models.py",
        "api/services/hybrid/pipeline.py",
        "api/services/hybrid/position_sizing.py",
        "api/services/hybrid/prompts.py",
        "api/services/hybrid/risk_engine.py",
        "api/services/hybrid/signal_engine.py",
