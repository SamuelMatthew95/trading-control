...
try:
    ...
    print('✅ Orchestrator attributes: ' + str(len(required_attrs) - len(missing_attrs)) + ' present')
    if missing_attrs:
...
try:
    ...
    print('✅ Memory methods: ' + str(len(required_methods) - len(missing_methods)) + ' present')
    if missing_methods:
